...
def condition_selection_keyboard(asset: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        [
            InlineKeyboardButton("📈 Above Price", callback_data=f"cond_above"),
            InlineKeyboardButton("📉 Below Price", callback_data=f"cond_below"),
        ],
        [
            InlineKeyboardButton("📊 Change %", callback_data=f"cond_pct"),
        ],
        [
